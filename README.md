...
<p>Остальные файлы создадутся автоматически при первом старте помощника.
...
Все изменения в файлах считываются автоматически, перезапускать помощник не требуется.
